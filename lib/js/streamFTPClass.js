class runVideo {
	...
	genVideoIndex(){
		if(this.videoItr<10){
			return "_0"+this.videoItr+"_";
		}
		return "_"+this.videoItr+"_";
	}

	nextVideo(){

		this.videoItr+=1;
		let temp = this.videoURL.match(/_\d+_/gm);
		this.videoURL = this.videoURL.replace(temp, this.genVideoIndex())
		this.changeVideo();
		console.log("Episode: "+ this.genVideoIndex().replaceAll("_",""));
	}
